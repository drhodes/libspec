...
class TicTacToeGame:
    ...
    def _create_ui(self):
        ...
        controls_centered = urwid.Padding(controls, align='center', width='pack')
        
        # Center the grid for better visual balance
        grid_centered = urwid.Padding(grid_box, align='center', width='pack')
        
        # Center the status text
        status_centered = urwid.Padding(self.status_text, align='center', width='pack')
